...
%--------------------------------------
	\begin{UCtrayectoria}{Principal}
		...
		\UCpaso[\UCactor] Da clic en la \IUref {IU10} {Botton Activar}.
		\UCpaso Despliega el mensaje \bf {+ MSG3}.
		\UCpaso[\UCactor] El Dueño da clic en el \Ibutton {+ Si Activar!} para confirmar la operación.
	...
	\end{UCtrayectoria}
		...
		\begin{UCtrayectoriaA}{A}{El Medicamento no se encuentra en la base de datos}
			...
			\UCpaso Continua en el paso 2 del \UCref{CU11}.
		\end{UCtrayectoriaA}
